...
#sys.path.insert(1, '/users/kelvin/bin/google-cloud-sdk/platform/google_appengine')
#sys.path.insert(1, 'google-cloud-sdk/platform/google_appengine/lib/yaml/lib')
#sys.path.insert(1, 'alerted-us-scraper/lib')
...
class AppTestCase(unittest.TestCase):
    ...
    def test_rfs_post(self):
        ...
        responses.add(responses.POST, 'http://localhost:8080/api/v1/alerts/',
